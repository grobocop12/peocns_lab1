...
void Server::summarize(ostream &str)
{
    ...
    long numberOfPackets = arrivalIntervalCalc.getNumberOfPackets();
    long sentPackets = departureIntervalCalc.getNumberOfPackets();
    long lostPackets = numberOfPackets - sentPackets;
    double probabilityOfLosingPacket = (double)lostPackets / (double)numberOfPackets;
    str.width(10);
